...
def compute_euclidean_loss(pre, gt, rgb, mask):
    # reshape
    ...
    rgb_masked = tf.multiply(rgb, mask_num)
    ...
    return tf.add_n(tf.get_collection('losses'), name='total_loss'), gt_masked, rgb_masked, mask_num
