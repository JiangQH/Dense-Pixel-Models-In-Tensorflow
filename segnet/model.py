...
class Model(object):
    ...
    def inference(self, images):
        ...
        conv1_1 = convs('conv1_1', images, 3, 64, self.config.phase, bias_var=self.data_dict['conv1_1'][1],
                        weight_initializer=tf.constant_initializer(self.data_dict['conv1_1'][0]), wd=self.config.weight_decay)

        conv1_2 = convs('conv1_2', conv1_1, 64, 64, self.config.phase, bias_var=self.data_dict['conv1_2'][1],
                        weight_initializer=tf.constant_initializer(self.data_dict['conv1_2'][0]), wd=self.config.weight_decay,
                        )
